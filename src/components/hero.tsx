...
export function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="hero-section relative isolate flex min-h-[min(100svh,50rem)] flex-col justify-end overflow-hidden pt-24"
    >
      {/* Layer 1 — environment plate */}
      ...
      <motion.div
        className="pointer-events-none absolute right-[5vw] top-[18%] z-0 hidden w-[min(34vw,520px)] overflow-hidden border border-white/20 bg-background/30 p-2 shadow-2xl shadow-black/40 lg:block"
      ...
      {/* Content */}
      <motion.div
        className="hero-content relative mx-auto w-full max-w-7xl px-5 pb-[12vh] sm:px-8 md:pb-[10vh]"
